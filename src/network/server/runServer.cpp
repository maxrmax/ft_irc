...
/*   By: student <student>                          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/09 14:47:16 by student           #+#    #+#             */
/*   Updated: 2026/04/23 11:26:46 by student          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int pollDisconnect(Server &irc_server, pollfd &client_poll, size_t *poll_index)
{
    ...
    if (client_for_current_fd && client_for_current_fd->isToDisconnect())
    {
        ...
        {
            Channel& channel = irc_server.getChannel(channelName);
        ...
        {
            ClientUser* recipient = irc_server.getClientByFd(recipientFd);
            if (recipient)
